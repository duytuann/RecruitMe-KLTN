  ...
  return (
    <div className={`flex w-full md:w-1/3 items-center ${styles}`}>
      ...
      <input
        ...
        type="text"
        className="w-full md:w-64 p-2 outline-none bg-transparent text-base border-none"
          ...
          <div className="flex w-full items-center justify-around bg-white px-2 md:px-5 py-2.5 md:py-6 shadow-2xl rounded-full">
            ...
            <div>
              <CustomButton
                ...
                title="Search"
                containerStyles={
                  "text-white border-none py-2 md:py3 px-3 md:px-10 focus:outline-none bg-blue-600 rounded-full md:rounded-md text-sm md:text-base"
                }
              />
            </div>
          </div>
